...
public class ListContestCommand implements ICommand{
    ...
    public void execute(List<String> tokens) {
        //-
        if(tokens.size()==1){
            List<Contest> cl = contestService.getAllContestLevelWise(null);
            System.out.println(cl);
            return;}
        Level l1 =Level.valueOf(tokens.get(1));
        List<Contest> cl2 = contestService.getAllContestLevelWise(l1);
