...
public class UserService implements IUserService {
    ...
    public List<User> getAllUserScoreOrderWise(ScoreOrder scoreOrder){
     //-
     List<User> flag=userRepository.findAll();
     if(scoreOrder ==ScoreOrder.ASC){Collections.sort(flag,(a,b) -> a.getScore() -b.getScore());
    return flag;}else{Collections.sort(flag,(a,b)->b.getScore()-a.getScore());
    return flag;}
     //-
    }
