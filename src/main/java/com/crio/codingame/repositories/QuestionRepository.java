...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
        List<Question> l1 = new ArrayList<Question>(questionMap.values());
        return l1;
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
     ...
     //-
     List<Question> l1 = new ArrayList<Question>(questionMap.values());
    List<Question> questions=l1.stream().filter(e->e.getLevel().toString().equals(level.toString())).collect(Collectors.toList());
    return questions;
     //-
    }
